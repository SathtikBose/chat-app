...
export const AuthProvider = ({ children }) => {
  ...
  //   check if user is authenticated and is so set the user data and connect the socket
  ...
  //   connect socket function to handle socket connectiom and online users updates
